      ...
      <header>
        ...
        {isMenuVisible && (
          <div className="settings-menu visible">
            <ul>
              <li>
                <a href="#users" onClick={() => handleMenuClick("users")}>
                  List of Users
                </a>
              </li>
              <li>
                <a href="#builders" onClick={() => handleMenuClick("builders")}>
                  List of Builders
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="#signout" onClick={() => handleMenuClick("signout")}>
                  Sign Out
                </a>
              </li>
            </ul>
