...
INSERT INTO company (company_id, annual_revenue, construction_type, founding_date, license_number, company_name, number_of_employees, address_id, builder_id, contact_details_id) VALUES
...
INSERT INTO construction_details (construction_detail_id, area_in_sq_ft, construction_description, construction_type) VALUES
(1, 5000, 'Residential Apartments in Mumbai', 'APARTMENT'),
(2, 15000, 'Shopping Mall in Delhi', 'MALL'),
(3, 8000,  'Warehouse in Hyderabad', 'WAREHOUSE'),
(4, 3000, 'Luxury Villas in Bangalore', 'HOUSE'),
(5, 7000,  'High-rise Apartments in Pune', 'APARTMENT'),
(6, 14000, 'Commercial Mall in Mumbai', 'MALL'),
(7, 9000,  'Storage Warehouse in Chennai', 'WAREHOUSE'),
(8, 3500,  'Independent Houses in Chennai', 'HOUSE'),
(9, 7500,  'Apartments in Kochi', 'APARTMENT'),
(10, 13000,  'Shopping Complex in Bangalore', 'MALL');
